...
public class ActionFragmentDeclarationImpl extends MultipleContextDeclarationImpl implements
		IActionFragmentDeclaration {

	public ActionFragmentDeclarationImpl(Token token) {
		super(token);
	}
	...
	public String dump(int indent) {
		return doIndent(indent) + "ActionFragment " + getId() + NEWLINE
