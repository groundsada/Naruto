...
public class ConditionalActionImpl extends ActionImpl implements IConditionalAction {

	public ConditionalActionImpl() {
	}

	public ConditionalActionImpl(Token token) {
		super(token);
	}
	...
	public ICompoundAction getThen() {
		return (ICompoundAction) getChild(1);
	}

	public ICompoundAction getElse() {
		if (getChildCount() < 3)
			return null;
		return (ICompoundAction) getChild(2);
	}
